...
#Forzamos una petición de sudo antes de quitar el ratón
sudo pacman -Q > /dev/null 2>&1
...
#Decimos que esperen un poco para que no se alarmen mientras instalamos lolcat
echo -e "${greenColour}[+]${endColour} ${grayColour}Iniciando el script...${endColour}"
